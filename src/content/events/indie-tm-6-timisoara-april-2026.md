...
![TypeUI design skill files](/screenshots/typeui-design-skills.png)

The core concept is "design skills": curated style files that define a visual language. Paper, Bento, Neobrutalism, Bold, Clean, and seven others. Each skill is a complete design system you can pull into your project with one command. The CLI downloads the skill file, applies it to your AI-generated components, and the output looks like a designer touched it.

![TypeUI Paper design skill](/screenshots/typeui-paper.png)

![TypeUI Neobrutalism design skill](/screenshots/typeui-neobrutalism.png)
